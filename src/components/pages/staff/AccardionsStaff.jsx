            ...
            <Card className="maecanes__card" key={index}>
              <div onClick={changeHandler}>
                <CustomToggle eventKey={el.id}>
                  ...
                  <div
                    className={
                      toggle && iventKey == el.id ? "minus--img" : "plus--img"
                    }
                  >
                    <img
                      src={toggle === true && iventKey == el.id ? minus : plus}
                      alt="plus"
                    />
                  </div>
                </CustomToggle>
...
export default AccardionsStaff;
